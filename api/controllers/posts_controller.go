...
func (app *App) CreatePost(w http.ResponseWriter, r *http.Request) {
	...
	postCreated, err := post.SavePost(app.DB)
	if err != nil {
...
func (app *App) GetPosts(w http.ResponseWriter, r *http.Request) {
	...
	posts, err := post.FindAllPosts(app.DB)
	if err != nil {
...
func (app *App) GetPost(w http.ResponseWriter, r *http.Request) {
	...
	postReceived, err := post.FindPostByID(app.DB, pid)
	if err != nil {
		responses.ERROR(w, http.StatusInternalServerError, err)
		return
	}
...
func (app *App) UpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	postUpdated, err := post.UpdatePost(app.DB, pid)
...
func (app *App) DeletePost(w http.ResponseWriter, r *http.Request) {
	...
	_, err = post.DeletePost(app.DB, pid, uid)
	if err != nil {
		responses.ERROR(w, http.StatusBadRequest, err)
		return
	}
